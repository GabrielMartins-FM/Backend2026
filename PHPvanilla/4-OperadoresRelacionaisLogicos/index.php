...
//1. //1. Dados que vieram fo aplicativo do celular do Cliente
$idadeCliente = 25;
$rendaMEnsal = 4000.00;
...
//3. O cerebro da operação: Avaliação das regras do Negocio
...
<body>
    ...
    <h4>$rendaSuficiente: <?php echo ($rendaSuficiente ? "sim" : "não") ?></h4>
